...
- BP_Greenhouse наследуется от актора и отвечает за визуализацию состояния теплицы. Через него также можно управлять теплицей, используя Debug методы, описанные выше
